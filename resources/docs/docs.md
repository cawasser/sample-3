...
The `home-routes` handler in the `sample-3.routes.home` namespace
...
The `home-page` function will in turn call the `sample-3.layout/render` function
...
The rest of this page is rendered by ClojureScript found in the `src/cljs/sample_3/core.cljs` file.



#### Organizing the routes

The routes are aggregated and wrapped with middleware in the `sample-3.handler` namespace:
...
Request middleware functions are located under the `sample-3.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `sample-3.dev-middleware` namespace found in
